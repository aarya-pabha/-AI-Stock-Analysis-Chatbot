...
*   **Agent Models:** Vision-Language Models (VLMs) like Google Gemini 3.1 Pro Preview (for Orchestration) and Gemini 3.1 Flash Lite Preview (for Analysts) capable of multimodal reasoning (interpreting charts + data).
